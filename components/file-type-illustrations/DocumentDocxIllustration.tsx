export const DocumentDocxIllustration = () => {
    return (
        <div
            aria-hidden
            className="relative size-fit">
            <div className="z-2 after:border-foreground/15 text-shadow-sm absolute -right-3 bottom-2 rounded bg-blue-500 px-1.5 py-0.5 text-[10px] font-semibold text-white shadow-lg shadow-blue-900/25 after:absolute after:inset-0 after:rounded after:border">DOC</div>
